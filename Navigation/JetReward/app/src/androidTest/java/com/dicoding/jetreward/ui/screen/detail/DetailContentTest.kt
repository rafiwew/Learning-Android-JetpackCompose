...
class DetailContentTest {
    ...
    private val fakeOrderReward = OrderReward(
        reward = Reward(4, R.drawable.reward_4, "Jaket Hoodie Dicoding", 7500), count = 0
    )
    ...
    @Test
    fun increaseProductButtonEnabled() {
    ...
    @Test
    fun increaseProductCorrectCounter() {
